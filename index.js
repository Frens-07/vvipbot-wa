...
const BotName = 'ASUNA BOT'; 
const instagram = 'syachfanailham77'; 
const aktif = 'Kapan bot aktif';24h
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Agus\n' // Nama kamu
            + 'ORG:VVIPINDO;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6289503625110:+62 895-0362-5110\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
var jam = moment(24h).format("HH:mm");
